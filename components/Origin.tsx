...
const callouts = [
  { label: 'CURRENTLY', value: 'FULL STACK DEV / LINCHPIN' },
  { label: 'STUDYING', value: 'B.TECH CSE / NIAT / 8.1 CGPA' },
  { label: 'BASED IN', value: 'INDIA' },
  { label: 'STACK', value: 'GO / TS / MERN / PY' },
];
      ...
      <div ref={ref} className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
        ...
        <div className="lg:col-span-8 space-y-6 text-[var(--color-v2-text)]/90">
          ...
          >
            ...
            a <span className="text-[var(--color-v2-orange)]">Full Stack Web Developer</span> intern at
            Linchpin Soft Solutions. I&apos;ve shipped a stack of full-stack apps - but lately
            I&apos;ve been pulled toward the{' '}
            <span className="text-[var(--color-v2-orange)]">backend</span>: queues, concurrency, and
            the stuff that has to stay correct when things fail. Somewhere between{' '}
